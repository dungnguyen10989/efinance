...
declare module 'react-native-onesignal' {
  ...
  export default class OneSignal {
    ...
    public static Configure(
      undocumentedParam1?: any,
      undocumentedParam2?: any,
    ): void;
     ...
     * @param {string or function} emailAuthCodeOrCallback Email auth code should be securely generated by your backend server, callback for case setEmail2 bellow
     * @param {Function} callback Handler function for error if it occurred
     */
    public static setEmail(
      email: string,
      emailAuthCodeOrCallback: (error?: any) => {} | string,
      callback: (error?: any) => {},
    ): void;
    ...
    // public static setEmail2(email: string, callback: (error?: any) => {}): void;
...
declare module 'local-redux' {
   ...
   *
   * @param type action type, destructuring from AllTypes
